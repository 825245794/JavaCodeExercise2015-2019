...
String form_email="04151010";
String form_password="A21210000+*";	
String redir="http://jw.jluzh.com/xs_main.aspx?xh="+form_email;
String login_src="http://jw.jluzh.com";
...
String result1=EntityUtils.toString(entity1,"gb2312");
...
String src="http://jw.jluzh.com/CheckCode.aspx";
...
File fileDir=new File("/Users/LJL/Desktop/img");
if(!fileDir.exists()){
fileDir.mkdirs();
}
File file=new File("/Users/LJL/Desktop/img／yzm.png");
if(file.exists()){
file.delete();
}
